...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFF3F9496);
  late Color secondaryColor = const Color(0xFF262D34);
  late Color tertiaryColor = const Color(0xFFC5E5E7);
  late Color alternate = const Color(0xFFFFA130);
  late Color primaryBackground = const Color(0xFF0C1C1D);
  late Color secondaryBackground = const Color(0xFF3F9496);
  late Color primaryText = const Color(0xFFF1F9F9);
  late Color secondaryText = const Color(0xFF0C1C1D);
